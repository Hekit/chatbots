...
# konstanty
my $pst_preklep = 0; # je to 0-100 < preklep
...
my @end_dialogue = (
	"To by pro tuto chvíli stačilo.", 
	"Omlouvám se, ale musím jít, než mi zavře bufet.",
    "To je už tolik hodin? Omluvte mě, musím se rozloučit.",
    "Omlouvám se, už musím jít, mám důležitou schůzku.",
    "Už musím jít, za chvíli mám projev v televizi.");
